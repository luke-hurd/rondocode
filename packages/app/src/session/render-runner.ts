...
// Shared by the in-app WAV export and the server MCP/CLI tools (server
// re-exports this module). App-local imports keep one pipeline for both.
import { evalCode } from './evalCode'
import type { Diagnostic } from './evalCode'
import { baseScope } from './scope'
import { Scheduler } from '@rondocode/pattern'
import type { ControlMap, Pattern } from '@rondocode/pattern'
import { BLOCK, duckReleaseCoeff, gainReductionDb, smoothCoeff, PostChain, renderOffline } from '@rondocode/engine'
import type { RenderEvent, SynthDef } from '@rondocode/engine'
